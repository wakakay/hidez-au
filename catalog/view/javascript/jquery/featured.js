...
jQuery(function($) {
     ...
     * 效果：高亮 + 信息框上移 
     */
    var slideHoverItemSelector = '.box .box-conten1t li';
     ...
     * 左模块鼠标hover
     */
    var leftHoverItemSelector = '#featured .mod-left .js-toggle li .photo a';
     ...
     * 右模块鼠标hover
     */
    var rightHoverItemSelector = '#featured .mod-right .js-toggle li';
...
jQuery(function($) {
    ...
    NameSpace.initSlide = function(){
        ...
        // 左滑动按钮的事件处理
        $('.box .box-conten1t .left-btn').live('click',function(evt){
            // for request log
            var reqLogDetail = [
        ...
        // 右滑动按钮的事件处理
        $('.box .box-conten1t .right-btn').live('click',function(evt){
            var reqLogDetail = [
        ...
        // tab 切换事件处理
        $('.box .tab a').live('click', function(evt){
            var tab = $(this);
        ...
        // =====================================================
        var autoPlay = true;
        $('.box, .box .box-conten1t li').live('mouseover', function(evt){
            autoPlay = false;
        }).live('mouseout', function(evt){
            autoPlay = true;
        });
