...
<div id="content" class="product"> 
 <?php echo $content_top; ?><?php echo $column_left; ?><?php echo $column_right; ?>
  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <div class="image">
        <span class='zoom' id='images'>
          <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" width="400" height="310" id="images" /></a>
        </span>
      </div>
      ...
      <div class="image-additional">
        ...
        <a title="<?php echo $heading_title; ?>"><img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" width="70" height="57" /></a>
        <?php } ?>
      </div>
      <?php } ?>
    </div>
    ...
    <div class="right">
      ...
      <div class="price">
        ...
        <?php echo $price; ?>
        <?php } else { ?>
        <span class="price-old"><?php echo $price; ?></span> <span class="price-new"><?php echo $special; ?></span><span class="ui-img-sale"></span>
        <?php } ?></div>
  ...
  <div id="tab-review" class="tab-content">
    ...
    <!--span><?php echo $entry_good; ?></span--></div><br />
    <br />
    <b><?php echo $entry_captcha; ?></b><br>
    <p style="clear:both; overflow:hidden;"><input type="text" name="captcha" value="" style="width:150px; padding:3px 0; color:#ddd;"/></p>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onComplete: function(file, json) {
		...
		if (json['error']) {
			$('#option-<?php echo $option['product_option_id']; ?>').append('<span class="error">' + json['error'] + '</span>');
		}
