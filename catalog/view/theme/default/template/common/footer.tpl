<div id="footer">
  <div class="flag"></div>
    <div class="link">
      <ul>
        <li><a href="https://www.facebook.com/HidezSuits" target="_blank"><img src="catalog/view/theme/default/images/fk.png" title="fackbook" alt="fackbook"/></a></li>
        <li><a href="https://www.instagram.com/hidezaustralia/" target="_blank"><img src="catalog/view/theme/default/images/instagram.png" title="instagram" alt="instagram"/></a></li>
        <li><a href="" target="_blank"><img src="catalog/view/theme/default/images/tt.png" title="twitter" alt="twitter" /></a></li>
        <li><a href="javascript:;" target="_blank"><img src="catalog/view/theme/default/images/yt.png" title="YouTube" alt="YouTube" /></a></li>
        <li><a href="javascript:;" target="_blank"><img src="catalog/view/theme/default/images/yah.png" title="YAHOO" alt="YAHOO" /></a></li>
      </ul>
    </div>
    <div class="col">
