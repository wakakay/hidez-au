		...
		if ($category_info) {
	  	$this->document->setTitle($category_info['name']);
			...
			foreach ($results as $result) {
				...
				$this->data['categories'][] = array(
					'name'  => $result['name'],
					'thumb'  => $this->model_tool_image->resize($result['image'],"330","218"),
			...
			foreach ($results as $result) {
				...
				$this->data['products'][] = array(
					...
					'meta_description' => utf8_substr(strip_tags(html_entity_decode($result['meta_description'], ENT_QUOTES, 'UTF-8')), 0, 350) . '..',
					'price'       => $price,
					'special'     => $special,
					'tax'         => $tax,
