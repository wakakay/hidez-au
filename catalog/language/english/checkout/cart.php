...
// Text
$_['text_success']           = 'Success: You have added <a href="%s">%s</a> to your <a href="%s">shopping cart</a> or <a href="?route=common/home#shop">shop now</a>!';
...
$_['text_items']             = '<span class="cell-items">%s item(s) - %s in carts</span>';
$_['text_total_items']       = '<span class="cell-total">%s</span>';
