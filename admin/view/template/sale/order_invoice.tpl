...
<div style="page-break-after: always;">
    ...
    <table class="address">
        ...
        <tr>
            <td>
                <p><?php echo $text_firstname; ?>   <?php echo $payment_firstname; ?></p>
                <p><?php echo $text_lastname; ?>    <?php echo $payment_lastname; ?></p>

                <p><?php echo $text_address_1; ?>   <?php echo $payment_address_1; ?></p>

                <p><?php echo $text_city; ?>    <?php echo $payment_city; ?></p>

                <p><?php echo $text_zone; ?> <?php echo $payment_zone; ?></p>
                <?php if ($payment_postcode) { ?>
                <p><?php echo $text_postcode; ?>    <?php echo $payment_postcode; ?></p>
                <?php } ?>
                <p><?php echo $text_country; ?><?php echo $payment_country; ?></p>

                <p><?php echo $text_email; ?><?php echo $order['telephone']; ?></p>
                <p><?php echo $text_telephone; ?><?php echo $order['email']; ?></p>
