          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <tr>
                    <td><?php echo $entry_benefit; ?></td>
                    <td><textarea
                            name="product_description[<?php echo $language['language_id']; ?>][benefit]"
                            id="benefit<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['benefit'] : ''; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td><?php echo $entry_testimonial; ?></td>
                    <td><textarea
                            name="product_description[<?php echo $language['language_id']; ?>][testimonial]"
                            id="testimonial<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['testimonial'] : ''; ?></textarea>
                    </td>
                </tr>
              <tr>
        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              ...
              <td><input type="text" name="model" class="cell-max-input" value="<?php echo $model; ?>" />
                <?php if ($error_model) { ?>
            ...
            <tr>
              <td><?php echo $entry_maxprice; ?></td>
              <td><input type="text" name="maxprice" value="<?php echo $maxprice; ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" name="quantity" value="<?php echo $quantity; ?>" size="2"  style="width:50px;"/></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><img src="<?php echo $thumb; ?>" alt="" id="thumb" /><br />
                  <input type="text" name="image" class="cell-max-input" value="<?php echo $image; ?>" id="image" /><br />
        ...
        <div id="tab-links">
          <table class="form">
            <tr>
              ...
              <td><input type="text" name="manufacturer" class="cell-max-input" value="<?php echo $manufacturer ?>" /><input type="hidden" name="manufacturer_id" value="<?php echo $manufacturer_id; ?>" /></td>
            </tr>
            <tr>
          ...
          <table id="images" class="list">
            <thead>
              <tr>
                ...
                <td class="left"><?php echo $entry_to_option_name; ?></td>
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                  <td class="left">
                    <div class="image"><img src="<?php echo $product_image['thumb']; ?>" alt="" id="thumb<?php echo $image_row; ?>" /></div>
                    <div><input class="cell-max-input" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['image']; ?>" id="image<?php echo $image_row; ?>" /></div>
                 ...
                 <td class="left">
                    <input type="text" name="product_image[<?php echo $image_row; ?>][to_option_name]" value="<?php echo $product_image['to_option_name']; ?>" />
                 </td>
...
CKEDITOR.replace('benefit<?php echo $language['language_id']; ?>', {
    filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
    filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
    filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
    filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
CKEDITOR.replace('testimonial<?php echo $language['language_id']; ?>', {
    filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
    filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
    filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
    filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
function addOptionValue(option_row) {	
	...
	html += '    <td class="right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][quantity]" value="9999" size="3" /></td>'; 
...
function addImage() {
	...
	html += '  <tr>';
    html += '    <td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" /><div><input class="cell-max-input" name="product_image[' + image_row + '][image]" value="" id="image' + image_row + '" /></div><a onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
    html += '    <td class="left"><input type="text" name="product_image[' + image_row + '][to_option_name]" value="" /></td>';
