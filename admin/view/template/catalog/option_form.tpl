    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            <td><?php echo $entry_classname; ?></td>
            <td><input type="text" name="option_description[<?php echo $language['language_id']; ?>][classname]" value="<?php echo isset($option_description[$language['language_id']]) ? $option_description[$language['language_id']]['classname'] : ''; ?>" class="cell-input" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_explainname; ?></td>
            <td><input type="text" name="option_description[<?php echo $language['language_id']; ?>][explainname]" value="<?php echo isset($option_description[$language['language_id']]) ? $option_description[$language['language_id']]['explainname'] : ''; ?>" class="cell-input" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_explainhref; ?></td>
            <td><input type="text" name="option_description[<?php echo $language['language_id']; ?>][explainhref]" value="<?php echo isset($option_description[$language['language_id']]) ? $option_description[$language['language_id']]['explainhref'] : ''; ?>" class="cell-input" /></td>
          </tr>
          <tr>
        ...
        <table id="option-value" class="list">
          <thead>
            <tr>
              ...
              <td class="left" width="200"><?php echo $entry_option_parent; ?></td>
          ...
          <tbody id="option-value-row<?php echo $option_value_row; ?>">
            <tr>
              ...
              <td class="left">
                <input type="text" name="option_value[<?php echo $option_value_row; ?>][option_value_description][<?php echo $language['language_id']; ?>][option_parent]" value="<?php echo isset($option_value['option_value_description'][$language['language_id']]) ? $option_value['option_value_description'][$language['language_id']]['option_parent'] : ''; ?>" />
                </td>
...
function addOptionValue() {
	...
	html += '<td class="left"><input type="text" name="option_value[' + option_value_row + '][option_value_description][<?php echo $language['language_id']; ?>][option_parent]" value="" /></td>';
