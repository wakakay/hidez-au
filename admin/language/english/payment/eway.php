<?php
// Heading
$_['heading_title']      = 'eWAY Rapid v3';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified your eWAY module details!';
$_['text_eway']   = '<a onclick="window.open(\'http://www.eway.com.au/\');"><img src="view/image/payment/eway_au.jpg" alt="eWAY AU" title="eWAY AU" style="border: 1px solid #cccccc;" /></a>';
...
$_['entry_username']	 = 'eWAY username:';
...
$_['error_username'] = 'eWAY username is required!';
...
$_['help_username']   = '<span style="font-size:11px; color:#999">Your eWAY username from eWAY website.</span>';
$_['help_password']   = '<span style="font-size:11px; color:#999">Your eWAY password from eWAY website.</span>';
