...
class ControllerCatalogOption extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['options'][] = array(
				...
				'explainname'=> $result['explainname'],
				'explainhref'=> $result['explainhref'],
		...
		$this->data['class_name'] = $this->language->get('class_name');
	...
	protected function getForm() {
		...
		$this->data['entry_explainname'] = $this->language->get('entry_explainname');
		$this->data['entry_explainhref'] = $this->language->get('entry_explainhref');
		$this->data['entry_type'] = $this->language->get('entry_type');
		$this->data['entry_option_value'] = $this->language->get('entry_option_value');
		$this->data['entry_option_parent'] = $this->language->get('entry_option_parent');
		...
		if (isset($this->request->post['option_parent'])) {
			$option_parent = $this->request->post['option_parent'];
		} elseif (isset($this->request->get['option_id'])) {
			$option_parent = $this->model_catalog_option->getOptionValueDescriptions($this->request->get['option_id']);
		} else {
			$option_parent = array();
		}
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			foreach ($options as $option) {
				...
				$json[] = array(
					...
					'classname'    => strip_tags(html_entity_decode($option['classname'], ENT_QUOTES, 'UTF-8')),
		...
		foreach ($json as $key => $value) {
			$sort_order[$key] = $value['name'];
			$sort_order[$key] = $value['classname'];
			$sort_order[$key] = $value['explainname'];
			$sort_order[$key] = $value['explainhref'];
		}
