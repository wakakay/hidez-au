...
class Currency {
  	...
  	public function set($currency) {
		...
		public function formatProduct($number, $currency = '', $value = '', $format = true) {
    	...
    	if (($symbol_left) && ($format)) {
      		$string .= '<b class="unit">'.$symbol_left.'</b>';
    	}
    	...
    	$string .= '<b class="money">'.number_format(round($value, (int)$decimal_place), (int)$decimal_place, $decimal_point, $thousand_point).'</b>';
